...
let favoriteFoods = ['tonkatsu ramen', 'gyro', 'tom kha', 'lemongrass chicken']; 
...
console.log('Number favorite foods:', favoriteFoods.length);
...
favoriteFoods.unshift('vindaloo');
...
favoriteFoods.splice(1,1, 'sushi');
console.log('Favorite foods are now', favoriteFoods);
...
let animalFoods = animalArray.concat(favoriteFoods);
